...
public class activity_Admin_Login extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__admin__login);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            //start the profile
                            finish();
                            startActivity(new Intent(getApplicationContext(),activity_Admin_Home.class));
                        }
                    }
                });
    }
    ...
    public void onClick(View view) {
        if (view == Login) {
            startActivity(new Intent(this,activity_Admin_Home.class));
